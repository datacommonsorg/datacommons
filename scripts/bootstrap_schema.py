...
sys.path.append(os.path.join(os.path.dirname(__file__), "..", "packages", "datacommons-api"))
sys.path.append(os.path.join(os.path.dirname(__file__), "..", "packages", "datacommons-db"))
...
CORE_NODES = [
    ...
    {"subject_id": "rdfs:subPropertyOf", "types": ["rdf:Property"], "value": "subPropertyOf"},
    ...
    {"subject_id": "schema:description", "types": ["rdf:Property"], "value": "description"},

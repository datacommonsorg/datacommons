...
# 1. Spanner Emulator Compatibility & Vertex DDL Filter
try:
...
# 2. Fake GCS Directory & File Handling Compatibility
try:
    import fs_gcsfs
    from google.auth.credentials import AnonymousCredentials
...
# 3. Base DC Entity Resolution Fallbacks during Data Ingestion
try:

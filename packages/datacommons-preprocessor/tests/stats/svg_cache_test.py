...
_TEST_DATA_DIR = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "test_data", "cache"
)
...
class TestCache(unittest.TestCase):
    ...
    def test_generate_svg_cache_internal(self, test_name: str):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            svg_cache = _generate_svg_cache_internal(
                svg_triples, sv_triples, specialized_names
            )
    ...
    def test_encode_decode(self):
        ...
        self.assertEqual(serialized_proto, expected_serialized_proto, "decoded bytes")

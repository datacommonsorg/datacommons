...
_TEST_DATA_DIR = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "test_data", "variable_per_row_importer"
)
...
def _test_import(test: unittest.TestCase, test_name: str):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        if test_name == "multi_entity_custom_dimensions":
            ...
            test.assertEqual(
                set(called_args), {"geoId/06", "country/FRA", "geoId/08", "country/DEU"}
            )
    ...
    def test_unresolved_entity_raises_error(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with mock.patch.object(
                dc, "resolve_entities", return_value={}
            ) as mock_resolve:

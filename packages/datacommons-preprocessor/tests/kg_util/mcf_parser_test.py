...
class MCFParserTest(unittest.TestCase):
    ...
    def test_success(self):
        ...
        (
            ...
            """
                Node: MTV
                # City shouldn't be quoted, but we know typeOf is a ref prop.
                typeOf: "City"
        ...
        (
            # MCF with multiple (chained) nodes.
            """
                Node: Place1
                typeOf: schema:City
                name: "Mountain View"
                ...
                """,
            [
                ['Place1', 'typeOf', 'City', 'ID'],
                ['Place1', 'name', 'Mountain View', 'VALUE'],
                ['Pop1', 'typeOf', 'StatisticalPopulation', 'ID'],
                ['Pop1', 'location', 'l:Place1', 'ID'],
                ['Pop1', 'populationType', 'Person', 'ID'],
                ['Obs1', 'typeOf', 'Observation', 'ID'],
                ['Obs1', 'observedNode', 'l:Pop1', 'ID'],
                ['Obs1', 'measuredProperty', 'income', 'ID'],
                ['Obs1', 'medianValue', '10000', 'VALUE']
            ]
        ),
    ]
        # yapf: enable

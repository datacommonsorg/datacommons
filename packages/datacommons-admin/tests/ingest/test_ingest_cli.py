...
@patch("datacommons_admin.utils.tf_utils.shutil.which")
@patch("datacommons_admin.utils.tf_utils.subprocess.run")
@patch("datacommons_admin.ingest.ingestion_job_client.AuthorizedSession")
@patch("datacommons_admin.ingest.ingestion_job_client.google.auth.default")
